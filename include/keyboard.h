...
void keyMapping(keypadEvent e)
{
  if(e.bit.EVENT == KEY_JUST_RELEASED)
  {
    ...
    switch(e.bit.KEY)
    {
      ...
      case(9): MAC550Left.select(!MAC550Left.selected); programmer_1.loadLampValues(1); nav.doOutput(); break;
      case(15): MAC550Right.select(!MAC550Right.selected); programmer_1.loadLampValues(2); nav.doOutput(); break;
